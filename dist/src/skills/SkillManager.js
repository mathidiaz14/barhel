...
export class SkillManager {
     ...
     */
    static parseSkillMarkdown(rawContent, defaultName = 'custom-skill') {
        ...
        if (match) {
            ...
            for (const line of lines) {
                ...
                if (colonIdx !== -1) {
                    ...
                    if (key === 'name' && val)
                        meta.name = val.toLowerCase().replace(/[^a-z0-9_-]/g, '-');
     ...
     */
    static async installFromUrl(url, customName) {
     ...
     */
    static buildSkillsSystemPrompt() {
