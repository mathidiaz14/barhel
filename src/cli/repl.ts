...
const AVAILABLE_SLASH_COMMANDS = [
  ...
  { name: '/memory', desc: 'Gestiona la memoria semántica del proyecto (add/list/remove/clear)', needsArg: 'Acción (add/list/remove/clear [hecho/id]):', optionalArg: true },
  { name: '/context', desc: 'Gestiona archivos anclados al prompt del agente (add/list/remove)', needsArg: 'Acción (add/list/remove [archivo]):', optionalArg: true },
  { name: '/prompt', desc: 'Guarda o ejecuta prompts personalizados (save/list/run/remove)', needsArg: 'Acción (save/list/run/remove [nombre]):', optionalArg: true },
  { name: '/workdir', desc: 'Cambia dinámicamente la ruta del workspace activo', needsArg: 'Ruta del directorio:', optionalArg: false },
  { name: '/branch', desc: 'Gestiona las ramas de Git del proyecto (new/switch/list/current)', needsArg: 'Acción (new/switch/list/current [nombre]):', optionalArg: true },
  { name: '/github', desc: 'Ejecuta comandos del CLI de GitHub (gh)', needsArg: 'Comando gh:', optionalArg: false },
  { name: '/mcp', desc: 'Gestiona conexiones a servidores MCP (Model Context Protocol)', needsArg: 'Acción (start/stop [server]):', optionalArg: false },
  { name: '/watch', desc: 'Inicia o detiene el observador de cambios en archivos (File Watcher)' },
  { name: '/rollback', desc: 'Revierte los cambios de la sesión al último snapshot estable' },
