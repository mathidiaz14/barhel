...
export class DualPane {
     ...
     */
    static renderLogoHeader(dividerWidth = 84) {
        const cy = pc.cyan;
        console.log();
     ...
     */
    static renderSessionDataBox(boxWidth = 84) {
     ...
     */
    static renderSubagentsBox(boxWidth = 84) {
     ...
     */
    static renderTodosBox(boxWidth = 84) {
     ...
     */
    static renderSessionHistory(session, boxWidth = 84) {
